...
void PlatformLibraryInit()
{
    ...
    VariableDefinePlatformVar(NULL, "xbuf", CharArrayType, CPtrWrapperBase::wrap(&xbuff), FALSE);
    ...
    VariableDefinePlatformVar(NULL, "cxmin", &IntType, CPtrWrapperBase::wrap(&Cxmin), FALSE);
    VariableDefinePlatformVar(NULL, "cxmax", &IntType, CPtrWrapperBase::wrap(&Cxmax), FALSE);
    VariableDefinePlatformVar(NULL, "cymin", &IntType, CPtrWrapperBase::wrap(&Cymin), FALSE);
    VariableDefinePlatformVar(NULL, "cymax", &IntType, CPtrWrapperBase::wrap(&Cymax), FALSE);
